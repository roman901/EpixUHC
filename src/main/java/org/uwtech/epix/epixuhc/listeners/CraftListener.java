...
import org.uwtech.epix.epixuhc.customitems.Craft;
			...
			if(craft != null){
				...
				if(human instanceof Player){
					...
					try {
						...
						if(GameManager.getGameManager().getConfiguration().getEnableCraftsPermissions() && !player.hasPermission("epixuhc.craft."+craft.getName())){
